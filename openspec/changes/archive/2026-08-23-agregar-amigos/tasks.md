...
- [x] 7.5 `review.md` con veredicto **APPROVED** (independiente, dos bugs reales encontrados y corregidos antes de archivar), `/opsx:archive` hecho (`openspec/changes/archive/2026-08-23-agregar-amigos/`), pendiente commit, push y PR de `feature/agregar-amigos` a `master` — nunca directo, per `CLAUDE.md`.
