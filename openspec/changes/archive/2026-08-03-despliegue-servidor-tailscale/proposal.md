...
- **Servidor** (Debian 13, `100.114.190.36` vía Tailscale, usuario `gonzalo` con sudo): nuevo Docker Engine + `docker compose` plugin, Git, una copia clonada del repositorio, un contenedor `apps/api` en ejecución con `restart: unless-stopped`.
