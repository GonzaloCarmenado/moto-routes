...
- Alcanzable solo por Tailscale (`[tailscale-ip-redactada]`, interfaz `tailscale0`) y por su LAN doméstica (`192.168.1.23/24`, interfaz `wlp2s0`) — sin IP pública propia.
