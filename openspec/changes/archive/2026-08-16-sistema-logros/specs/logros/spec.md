...
Cuando se otorga uno o varios logros nuevos tras una sincronización, el sistema SHALL mostrar una animación de atención completa por logro (título, descripción, icono), en cola secuencial si se desbloquea más de uno a la vez.
...
- **THEN** la animación de desbloqueo respeta esa preferencia (sin movimiento no esencial), mostrando igualmente el título, la descripción y el icono del logro
