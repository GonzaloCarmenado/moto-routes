# route-photo-storage Specification

## Purpose

Permite subir, listar, descargar y borrar las fotos asociadas a una ruta del usuario autenticado, almacenadas cifradas en reposo y servidas únicamente a través de la propia API — nunca mediante una URL directa al almacenamiento subyacente. Cubre además cómo el cliente móvil agrupa y presenta esas fotos al visualizarlas desde el mapa de una ruta, agrupándolas por proximidad GPS en vez de mostrar siempre la ruta completa.
