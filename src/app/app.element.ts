...
class AppRoot extends BaseElement {
  ...
  protected render(): void {
    ...
    // Cockpit dial (speedometer placeholder)
    ...
    nav.innerHTML = `
      ...
      <button class="nav-item">
        <svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          ...
          <path d="M9 4v16" fill="none" stroke-width="2"/>
          <path d="M15 4v16" fill="none" stroke-width="2"/>
          <path d="M4 9h16" fill="none" stroke-width="2"/>
          <path d="M4 15h16" fill="none" stroke-width="2"/>
        </svg>
        <span class="nav-item__label">Rutas</span>
      </button>
      <button class="nav-item">
        <svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          <path d="M12 2L2 7l10 5 10-5-10-5z" fill="none" stroke-width="2"/>
          <path d="M2 17l10 5 10-5" fill="none" stroke-width="2"/>
          <path d="M2 12l10 5 10-5" fill="none" stroke-width="2"/>
        </svg>
      ...
      <button class="nav-item">
        <svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="12" cy="12" r="3" fill="none" stroke-width="2"/>
          <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" fill="none" stroke-width="2"/>
        </svg>
