...
- **Feature activo**: Ninguno en desarrollo — el código de `mejoras-usabilidad` está terminado y con review APPROVED, solo falta mergear el PR #45. Fotos de ruta (`specs/features/fotos-ruta.md`) está ahora en 33/33 AC; ver [[fotos-ruta-review]].
