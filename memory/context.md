...
- **Próximo hito**: Sin spec activa. Pendientes conocidos fuera de alcance: en `fotos-ruta` — test de EXIF con GPS real (AC-005/006), swipe entre fotos en el lightbox (AC-020); en `mejoras-usabilidad` — homogeneizar más los estados de carga si surge un tercer caso de uso (ISSUE-002). Los cambios de la sesión 2026-07-26 están sobre `feature/mejoras-usabilidad` (mismo branch del PR #45 aún abierto) — pendiente decidir si van en ese PR o en uno nuevo.
